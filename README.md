...
- [aligator/GoSlice](https://github.com/aligator/GoSlice) ([v0.3.7](https://github.com/aligator/GoSlice/releases/tag/v0.3.7), today) - This is an experimental slicer for 3d printing written in Go also usable as modular slicing lib.
