...
- [codenotary/immudb](https://github.com/codenotary/immudb) ([v1.0.1](https://github.com/codenotary/immudb/releases/tag/v1.0.1), 3 days ago) - immudb - world’s fastest immutable database
- [arp242/uni](https://github.com/arp242/uni) ([v2.2.0](https://github.com/arp242/uni/releases/tag/v2.2.0), 5 days ago) - Query the Unicode database from the commandline, with good support for emojis
...
- [muesli/deckmaster](https://github.com/muesli/deckmaster) ([v0.4.0](https://github.com/muesli/deckmaster/releases/tag/v0.4.0), 1 week ago) - An application to control your Elgato Stream Deck on Linux
...
- [Allow for non-string config map values](https://github.com/muesli/deckmaster/pull/32) on [muesli/deckmaster](https://github.com/muesli/deckmaster) (3 days ago)
- [Install libpam-dev in GitHub workflow](https://github.com/muesli/pam-beacon/pull/8) on [muesli/pam-beacon](https://github.com/muesli/pam-beacon) (5 days ago)
- [Enable Go modules &amp; switch to GitHub Actions](https://github.com/muesli/pam-beacon/pull/7) on [muesli/pam-beacon](https://github.com/muesli/pam-beacon) (5 days ago)
- [Update linter config](https://github.com/charmbracelet/glow/pull/279) on [charmbracelet/glow](https://github.com/charmbracelet/glow) (6 days ago)
...
- [ocelotsloth](https://github.com/ocelotsloth) (3 days ago)
- [angristan](https://github.com/angristan) (6 days ago)
