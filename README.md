...
- [muesli/obs-scene-switcher](https://github.com/muesli/obs-scene-switcher) - Tracks your active window and switches OBS scenes accordingly (6 days ago)
...
- [fix: make linter happy](https://github.com/muesli/markscribe/pull/44) on [muesli/markscribe](https://github.com/muesli/markscribe) (5 days ago)
...
- [taigrr/ssh-wars](https://github.com/taigrr/ssh-wars) - charm / bubbletea version of towel.blinkenlights.nl (4 days ago)
- [zricethezav/gitleaks](https://github.com/zricethezav/gitleaks) - Scan git repos (or files) for secrets using regex and entropy 🔑 (5 days ago)
