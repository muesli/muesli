...
- [charmbracelet/soft-serve](https://github.com/charmbracelet/soft-serve) ([v0.1.1](https://github.com/charmbracelet/soft-serve/releases/tag/v0.1.1), today) - A tasty, self-hostable Git server for the command line🍦
