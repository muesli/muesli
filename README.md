...
- [arp242/uni](https://github.com/arp242/uni) ([v2.0.0](https://github.com/arp242/uni/releases/tag/v2.0.0), 3 days ago) - Query the Unicode database from the commandline, with good support for emojis
- [hakavlad/nohang](https://github.com/hakavlad/nohang) ([v0.2.0](https://github.com/hakavlad/nohang/releases/tag/v0.2.0), 5 days ago) - A sophisticated low memory handler for Linux
