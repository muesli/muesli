...
- [muesli/deckmaster](https://github.com/muesli/deckmaster) ([v0.6.0](https://github.com/muesli/deckmaster/releases/tag/v0.6.0), 2 days ago) - An application to control your Elgato Stream Deck on Linux
- [muesli/streamdeck](https://github.com/muesli/streamdeck) ([v0.2.2](https://github.com/muesli/streamdeck/releases/tag/v0.2.2), 2 days ago) - An application and Go library to control your Elgato Stream Deck on Linux
- [muesli/gitty](https://github.com/muesli/gitty) ([v0.4.1](https://github.com/muesli/gitty/releases/tag/v0.4.1), 6 days ago) - Contextual information about your git projects, right on the command-line
...
- [Add replay buffer commands](https://github.com/muesli/obs-cli/pull/44) on [muesli/obs-cli](https://github.com/muesli/obs-cli) (1 day ago)
- [Remove unmaintained snap package](https://github.com/muesli/duf/pull/150) on [muesli/duf](https://github.com/muesli/duf) (5 days ago)
- [Bump go-pretty to v6.2.4](https://github.com/muesli/duf/pull/149) on [muesli/duf](https://github.com/muesli/duf) (5 days ago)
- [Support resolving SSH config stanzas](https://github.com/muesli/gitty/pull/25) on [muesli/gitty](https://github.com/muesli/gitty) (6 days ago)
- [Fix GitLab pagination](https://github.com/muesli/gitty/pull/24) on [muesli/gitty](https://github.com/muesli/gitty) (1 week ago)
