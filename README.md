...
- [orlangure/gocovsh](https://github.com/orlangure/gocovsh) ([v0.4.1](https://github.com/orlangure/gocovsh/releases/tag/v0.4.1), 1 day ago) - Go Coverage in your terminal: a tool for exploring Go Coverage reports from the command line 💻
- [minio/mc](https://github.com/minio/mc) ([RELEASE.2022-06-10T22-29-12Z](https://github.com/minio/mc/releases/tag/RELEASE.2022-06-10T22-29-12Z), 2 days ago) - MinIO Client is a replacement for ls, cp, mkdir, diff and rsync commands for filesystems and object storage.
...
- [docs: fix deprecation notes](https://github.com/charmbracelet/bubbletea/pull/339) on [charmbracelet/bubbletea](https://github.com/charmbracelet/bubbletea) (4 days ago)
